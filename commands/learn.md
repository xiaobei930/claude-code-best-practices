...
```bash
/learn                    # 从当前会话提取知识
/learn --status           # 查看已学习内容和置信度
/learn --export           # 导出学习内容（用于分享）
/learn --import <file>    # 导入他人的学习内容
```
...
```bash
/learn --import team-learnings.yaml
```
