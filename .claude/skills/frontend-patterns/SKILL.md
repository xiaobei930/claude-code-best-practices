...
| 维度     | 做法                                                         |
| -------- | ------------------------------------------------------------ |
| **字体** | 选择有**个性**的字体，标题和正文字体形成对比                 |
| **配色** | 提交一个**主导色**，用锐利的强调色，避免平均分配             |
| **布局** | 不对称、重叠、对角线流动、打破网格、负空间或密度控制         |
| **动画** | 聚焦**高影响力时刻**：精心编排的页面加载、交错出现、滚动触发 |
...
> Claude 有能力创造**非凡**的作品。不要保守，展示真正跳出框架、全身心投入独特视觉的设计。
